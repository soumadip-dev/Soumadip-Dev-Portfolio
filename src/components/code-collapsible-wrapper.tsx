  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 flex h-32 items-end justify-center group-data-[state=open]/collapsible:hidden">
        <div className="from-background absolute inset-0 bg-linear-to-t to-transparent mask-linear-[to_top,var(--background)_25%,transparent] backdrop-blur-[1px]" />

        <CollapsibleTrigger asChild>
          <Button
            className="dark:border-border dark:bg-background z-1 shadow-none dark:hover:bg-zinc-900"
            variant="outline"
            size="sm"
          >
            Expand
