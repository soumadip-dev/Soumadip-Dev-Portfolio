...
export function TypeTable({
  ...
  return (
    <div
      id={id}
      className={cn(
        'bg-surface inset-ring-border/64 @container my-[1.25em] flex flex-col gap-px overflow-hidden rounded-xl p-1 text-sm inset-ring-1',
        className
      )}
      {...props}
    >
      <div className="not-prose text-muted-foreground flex items-center px-3 py-2 font-medium">
...
function Item({
  ...
  return (
    <Collapsible
      id={id}
      className="group/type-item inset-ring-border data-open:bg-background rounded-lg data-open:inset-ring-1 data-open:not-last:mb-0.75"
    >
      <CollapsibleTrigger className="not-prose inset-ring-border hover:bg-accent focus-visible:inset-ring-ring/50 relative flex w-full flex-row items-center rounded-lg px-3 py-2 text-start text-sm outline-none group-data-open/type-item:rounded-b-none group-data-open/type-item:inset-ring-1 focus-visible:inset-ring-1 dark:hover:bg-[color-mix(in_oklab,var(--accent)_60%,var(--surface))] [&_svg]:size-4">
        <code
          className={cn(
        ...
        <div className="text-muted-foreground ml-auto shrink-0">I</div>
      </CollapsibleTrigger>
      ...
      <CollapsibleContent>
        <div className="grid grid-cols-[1fr_3fr] gap-y-3 p-3 text-sm">
          ...
          {typeDescription != null && (
            <>
              <p className="not-prose text-muted-foreground pr-3">Type</p>
          ...
          {defaultValue != null && (
            <>
              <p className="not-prose text-muted-foreground pr-3">Default</p>
          ...
          {parameters.length > 0 && (
            <>
              <p className="not-prose text-muted-foreground pr-3">Parameters</p>
          ...
          {example != null && (
            <>
              <p className="not-prose text-muted-foreground pr-3">Example</p>
          ...
          {returns != null && (
            <>
              <p className="not-prose text-muted-foreground pr-3">Returns</p>
