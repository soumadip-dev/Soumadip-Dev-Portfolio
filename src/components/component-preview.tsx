...
export function ComponentPreview({
  ...
  return (
    <div
      className={cn(
        'bg-surface inset-ring-border/64 my-[1.25em] rounded-xl inset-ring-1',
    ...
    >
      <Tabs defaultValue="preview" className="gap-0">
        <div className="z-1 px-4">
          <TabsList className="[&_svg]:text-muted-foreground h-10 rounded-none bg-transparent p-0 inset-ring-0 dark:bg-transparent [&_svg]:me-2 [&_svg]:size-4">
        ...
        <TabsContent className="px-1 pb-1" value="preview">
          <div
            ...
            className="bg-background relative rounded-[9px] border p-2 data-[show-buttons=true]:py-8.75"
          >
