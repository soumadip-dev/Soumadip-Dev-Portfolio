...
const components: MDXRemoteProps['components'] = {
  ...
  Steps: ({ className, ...props }: React.ComponentProps<'div'>) => (
    <div
      className={cn(
        'prose-h3:text-base relative md:ml-3 md:pl-7',
        'before:bg-line before:pointer-events-none before:absolute before:top-0 before:left-0 before:hidden before:h-full before:w-px before:-translate-x-1/2 before:md:flex',
        className
      )}
      {...props}
    />
